                                ...
                                <v-form ref="loginForm" v-model="valid" lazy-validation>
                                    <v-row>
                                        ...
                                        <v-col class="d-flex" cols="12" sm="3" xsm="12" align-end>
                                            <v-btn x-large block :disabled="!valid" color="success" @click="loginSubmit"> Login </v-btn>
                                        </v-col>
                                    </v-row>
                                </v-form>
                            </v-card-text>
                                ...
                                <v-form ref="registerForm" v-model="valid" lazy-validation>
                                    <v-row>
                                        ...
                                        <v-col class="d-flex ml-auto" cols="12" sm="3" xsm="12">
                                            <v-btn x-large block :disabled="!valid" color="success" @click="rigistrationSubmit">Register</v-btn>
                                        </v-col>
                                    </v-row>
                                </v-form>
                            </v-card-text>
